...
class CardLaporanMasuk extends StatelessWidget {
  final int maxItemsToShow;
  final String? statusFilter;
  final String? userRole;
  CardLaporanMasuk({this.maxItemsToShow = 3, this.statusFilter, this.userRole});
  ...
  Widget build(BuildContext context) {
    ...
    if (userRole == 'staff') {
      ...
      reportsQuery =
          reportsQuery.where('status', isEqualTo: 'Diteruskan ke Dinas');
    }
